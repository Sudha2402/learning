...
// two pointer will always work when we have only two reults, input required.//every operation based on involving two elements in array will work
...
//  we noticed that after increasing start, answer decease, hence on increasing end we want answer to be increasing. We find the opposite behavior hence it works.
