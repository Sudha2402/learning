...
const videoPlaylist = [
    ...
    // 'https://www.youtube.com/embed/Kj7GQtkSKEA?autoplay=0&si=gJl8G9D33VBstzCf',
    // 'https://www.youtube.com/embed/sURTQXxrynQ?autoplay=0&si=vZNS-Js38XEq-jej',
    // 'https://www.youtube.com/embed/rUNCAacEalg?autoplay=0&si=p8_MX8dA6RmZN4Fu',
    // 'https://www.youtube.com/embed/me4k9eqj2do?autoplay=0&si=TJrcL1Z8codqIH6F',
    // 'https://www.youtube.com/embed/j3_Xr5aeu0Q?autoplay=0&si=80cyyYAJRTLNN7Ag'
...
const videoDurations = [
    ...
    //add 1 exta second to play upto end

    11000, // 3:32 for video 1
    10000, // 4:14 for video 2
    13000, // 4:52 for video 3
    14000, // 3:41 for video 4
    16000, // 3:51 for video 5
    12000, // 3:03 for video 6
    19000, // 3:16 for video 7
    24000, // 3:28 for video 8
    13000, // 3:51 for video 9
...
function createPagesFromPlaylist() {
    ...
    videoPlaylist.forEach((videoUrl, index) => {
        ...
        // Add navigation buttons (except for first and last pages)
        if (index > 0) {
