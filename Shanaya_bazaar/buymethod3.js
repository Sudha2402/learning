    ...
    if (firstname == "" || firstname === undefined || lastname == ""
        ...
        if (email == EmailAddress) {
            ...
            if (document.getElementById("cartMethod") === undefined || document.getElementById("cartMethod") === null) {
                ...
                //     alert("Data saved and transferred");
...
// as we have used to call this multiple times hence useorderNumber is defined oly inside, hence we will put this onload action inside
...
function upadatequantityNumber(element, price, isIncreasing) {
    ...
    // var quantityTotalPrice = element.parentElement.nextElementSibling.firstElementChild;//quantity-total
...
function allCartBuy() {
    ...
    // alert(document.getElementsByClassName("remove-item").length);//it's giving 1
    ...
    if (document.getElementById("cartMethod") !== null) {
        ...
        if (param != "") {
            ...
            addToCartSave.addEventListener("click", function () {
                ...
                // http://localhost:3000/cart.html?productID=WEWKS1&productName=%20Georgette%20Salwar%20Suit%20Set%20Floral%20Embroidered&priceOfThisProduct=495&mainImagOfThisProduct=http://localhost:3000/product/women/ethnic%20wear/kurta%20sets/Pakistani%20Suit%20%20Women%20Kurta%20Pair/colors%20option/violet/main.png&sizeSelected=M

                // product/women/ethnic wear/kurta sets/Pakistani Suit  Women Kurta Pair/colors option/violet/main.png

                // UPDATE order_details set colorMainImage='product/women/ethnic wear/kurta sets/Pakistani Suit  Women Kurta Pair/colors option/violet/main.png'; //works
                ...
                // http://localhost:3000/cart.html?productID=WEWKS1&productName=%20Georgette%20Salwar%20Suit%20Set%20Floral%20Embroidered&priceOfThisProduct=495&mainImagOfThisProduct=http://localhost:3000/product/women/ethnic%20wear/kurta%20sets/Pakistani%20Suit%20%20Women%20Kurta%20Pair/colors%20option/green/main.png&sizeSelected=M
    ...
    // var priceOfOne = document.getElementsByClassName('priceOfEach');//undefined as class has ; and it will not take it as class , it will take quantity-plus ; btn as class 
    ...
    // to link the url of product along with the cart
...
// window.addEventListener("load", allCartBuy);//this works proper in case of cart but not in buymethod, for let it to work in buymethod, we will use another eventlister
// var item=document.getElementsByClassName("itemcount");
// alert(item.length);
...
// body.addEventListener("click",allCartBuy);
// window.addEventListener("load",allCartBuy);
