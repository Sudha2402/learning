...
int main()
{
    ...
    {
        /*Syntax ch = getchar( ); where ch is a char Var. When this function is executed, the computer will wait for a key to be pressed and assigns the value to the variable when the “enter” key pressed. putchar( ) function is used to display one character at a time on the monitor.*/
        ...
        scanf("%c", &b);
        ptr = (char *)malloc((chars + 1) * sizeof(char));//+1 is used to store the terminator \0 
