onmessage = function(e){//receieve the event// event click , event also passed here //here event is postmessage of .js file and object workerObj //workerObj.postMessage("Start worker");//data used not the value //value only for input element
    ...
    // postMessage(e.data); //undefined for document.write event.data
    // this.postMessage(e.data);//defined
