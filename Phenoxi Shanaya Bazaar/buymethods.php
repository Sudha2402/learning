...
<body>
    ...
    <section>
        ...
        <div class="container">
            ...
            <h2 class="px-5 p-2">My product</h2>
            <!-- this class is for links stylesheet to be used and it bring  distance in left -->
            <!-- px shows padding along x from left  -->
            <!-- p2 shows padding along y from top  -->
                ...
                <div>
                        ...
                        <div class="cart-item itemcount">
                            <div class="row">
                                ...
                                <div class="center-item">
                                    <!-- used to keen image and title in flex hrozontally -->
                                    <!-- center-item shows inline flex hozizontal -->
                                ...
                                <div class="center-item flexwrap">
                                    ...
                                    <div class="input-group">
                                        <!-- input-group keep the number slider horizontal , you can also use center-item here in place of input-group -->
                                        <!-- <button class="quantity-minus" class="btn"><i class="fas fa-minus"></i></button> -->
                    ...
                    <div class="pb-5 pt-2 ">
                        ...
                        <button type="button" class="btn btn-success undo" onclick="Undo()"
                            style="float: inline-start;padding: 10px 30px;font-size: 19px;color: white;display: none;">Undo
                            the removed items
                        </button>
                                ...
                                <div>
                                    ...
                                    <div id="paymentmode">
                                        ...
                                        <div>
                                            ...
                                            <br> <p style="color: rgb(2, 169, 47);">(Best Mode of payment, pay after receiving your product)</p> 
                                        </div>
                                        <div>
                                            <!-- we don't want card right now -->
                                            <input type="radio" id="card" name="payment-mode" value="card">
                                            <label for="card"> Card  </label>
                                            <br> <p style="color: rgb(207, 11, 11);">(takes extra charge hence prefer Cash on delivery)</p> 
                                        </div>
                                        <div>
                            ...
                            <form name="orderDetails">
                                ...
                                <div class="form-group">
                                    ...
                                    <p style="color: aqua;cursor: pointer;" id="trackLocation"
                                        onclick="trackLocation()">Track my
                                        current location
...
<script src="buymethod3.js"></script>
